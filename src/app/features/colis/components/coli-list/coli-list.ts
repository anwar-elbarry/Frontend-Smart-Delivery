...
export class ColiList implements OnInit {
  ...
  loadFakeData() {
    // Fake data for testing without authentication
    this.allColisList = [
      {
        id: '1',
        description: 'Colis électronique - Ordinateur portable',
        poids: 2.5,
        statut: ColisStatus.CREATED,
        priorite: Priority.HIGHT,
        villeDestination: 'Casablanca',
        zone: 'Zone Nord',
        livreur: 'Non assigné',
        clientExpediteur: 'Mohamed Ali',
        destinataire: 'Fatima Zahra'
      },
      {
        id: '2',
        description: 'Documents administratifs',
        poids: 0.5,
        statut: ColisStatus.IN_TRANSIT,
        priorite: Priority.MEDIUM,
        villeDestination: 'Rabat',
        zone: 'Zone Centre',
        livreur: 'Ahmed Bennani',
        clientExpediteur: 'Sara Idrissi',
        destinataire: 'Karim Alaoui'
      },
      {
        id: '3',
        description: 'Vêtements et accessoires',
        poids: 1.8,
        statut: ColisStatus.DELIVERED,
        priorite: Priority.LOW,
        villeDestination: 'Marrakech',
        zone: 'Zone Sud',
        livreur: 'Youssef Tazi',
        clientExpediteur: 'Leila Bennis',
        destinataire: 'Omar Fassi'
      },
      {
        id: '4',
        description: 'Matériel médical',
        poids: 3.2,
        statut: ColisStatus.COLLECTED,
        priorite: Priority.HIGHT,
        villeDestination: 'Fès',
        zone: 'Zone Est',
        livreur: 'Hassan Chraibi',
        clientExpediteur: 'Nadia Amrani',
        destinataire: 'Rachid Lahlou'
      },
      {
        id: '5',
        description: 'Pièces détachées automobiles',
        poids: 5.0,
        statut: ColisStatus.IN_STOCK,
        priorite: Priority.MEDIUM,
        villeDestination: 'Tanger',
        zone: 'Zone Nord',
        livreur: 'Non assigné',
        clientExpediteur: 'Kamal Hassani',
        destinataire: 'Samira Benjelloun'
      },
      {
        id: '6',
        ...
        zone: 'Zone Sud',
        livreur: 'Mehdi Berrada',
        clientExpediteur: 'Zineb Kadiri',
        destinataire: 'Amine Tahiri'
      },
      {
        id: '7',
        ...
        statut: ColisStatus.CREATED,
        priorite: Priority.HIGHT,
        villeDestination: 'Oujda',
        zone: 'Zone Est',
        livreur: 'Non assigné',
        clientExpediteur: 'Imane Slaoui',
        destinataire: 'Reda Haddad'
      },
      {
        id: '8',
        ...
        villeDestination: 'Casablanca',
        zone: 'Zone Centre',
        livreur: 'Tarik Benkirane',
        clientExpediteur: 'Hafsa Zeroual',
        destinataire: 'Jalil Marouane'
      }
    ];
